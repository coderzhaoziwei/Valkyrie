import Vue, { openBlock, createBlock, Fragment, renderList, toDisplayString } from 'vue';
...
var script = {
  ...
  computed: {
    ...mapState(["roles", "id", "state", "npcs", "items"]),
    title() {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", null, [
    (openBlock(true), createBlock(Fragment, null, renderList(_ctx.items, (item, key) => {
      return (openBlock(), createBlock("div", { key: key }, toDisplayString(item.name), 1 ))
    }), 128 ))
  ]))
}
...
//# sourceMappingURL=valkyrie.esm.js.map
